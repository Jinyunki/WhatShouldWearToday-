...
public class ResultByValue {
    ...
    private String resultWSD;

    private ResultByValue() {}
    public ResultByValue(String category, double categoryResult) {
        //온도
        if (category.equals("TMP")) {
            ...
            } else if (categoryResult >= 5 && categoryResult <= 8) {
            ...
            } else if (categoryResult >= 9 && categoryResult <= 11) {
            ...
            } else if (categoryResult >= 12 && categoryResult <= 16) {
    ...
    public void setResultWSD(String resultWSD) {
        this.resultWSD = resultWSD;
    }
    public String getClothesComment() {
        return clothesComment;
    }
    public String getResultWSD() {
        return resultWSD;
    }
}
